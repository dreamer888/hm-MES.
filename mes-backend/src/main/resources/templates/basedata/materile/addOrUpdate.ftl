        ...
        <form class="layui-form splayui-form" lay-filter="formTest">
            <div class="layui-row">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md10">
                    ...
                    <div class="layui-form-item">
                        <label for="js-materielDesc" class="layui-form-label ">物料描述
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" id="js-materielDesc" name="materielDesc"
                    ...
                    <div class="layui-form-item">
                        <label for="js-model" class="layui-form-label ">规格型号
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" id="js-model" name="model" lay-verify=""
                                   autocomplete="off"
                                   class="layui-input" value="${result.model}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="js-matType" class="layui-form-label ">物料类型
                        </label>
                        <div class="layui-input-inline">
                            <select id="js-matType" name="matType" lay-filter="matType-filter" lay-verify="">
                            </select>
                        </div>
                    </div>
...
<script>
    layui.use(['form', 'util'], function () {
        ...
        $('#js-qrcode').on('input',e=> {
            ...
            var len = arr.length;
            if(len>=3) {
                document.getElementById('js-materiel').value = arr[0];
