...
<div class="head">
    <h1>磁阻旋变自动生产线</h1>
    <div class="weather"> <b> <span id="showTime"></span> </b> </div>
    ...
    <ul class="clearfix">
        ...
        <li>
            <div class="bar">
                <div class="barbox">
                    <ul class="clearfix">
                        <li class="pulll_left counter">1866560</li>
                        <li class="pulll_left counter">2636</li>
                    </ul>
                </div>
                <div class="barbox2">
                    <ul class="clearfix">
                        <li class="pulll_left">当日生产数量</li>
                        <li class="pulll_left">产品统计</li>
                    </ul>
                </div>
            </div>
            <div class="map">
