        ...
        <form class="layui-form splayui-form">
            <div class="layui-row">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md6">
                    ...
                    <div class="layui-form-item">
                        <label for="js-mobile" class="layui-form-label ">手机号
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" id="js-mobile" name="mobile" lay-verify="" autocomplete="off" class="layui-input" value="${result.mobile}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label for="js-sex" class="layui-form-label ">性别</label>
                ...
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md6">
                    ...
                    <div class="layui-form-item">
                        <label for="js-is-deleted" class="layui-form-label ">状态</label>
