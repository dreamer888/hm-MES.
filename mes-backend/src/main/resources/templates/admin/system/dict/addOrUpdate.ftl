    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="js-name" name="name" lay-verify="" autocomplete="off" class="layui-input" value="${dict.name}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="js-value" name="value" lay-verify="" autocomplete="off" class="layui-input" value="${dict.value}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="js-type" name="type" lay-verify="" autocomplete="off" class="layui-input" value="${dict.type}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="js-descr" name="descr" lay-verify="" autocomplete="off" class="layui-input" value="${dict.descr}">
            </div>
        </div>
