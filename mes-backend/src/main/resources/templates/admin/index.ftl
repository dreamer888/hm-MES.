...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        ...
        <ul class="layui-nav layui-layout-right">
          <#--  <li class="layui-nav-item">
                <button type="button"  class="fa fa-github-alt " onclick="notice()"  data-method="setTop" >  B 视频</button>
            </li>-->
            <li class="layui-nav-item">
...
<script>
    ...
    function  notice(){
        layer.open({
            ...
            ,content: '<iframe style="height: 99%;width: 100%" src="www.dreammm.net/xxx.mp4"  border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>'
