...
public class spProductReq extends BasePageReq {
    ...
    public String getSerialIdLike() {
        return this.serialIdLike;
    }
    ...
    public void setSerialIdLike(String serialIdLike)  { this.serialIdLike= serialIdLike;}
